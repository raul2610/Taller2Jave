...
public class SandboxMapas
{
    ...
    {
    	Collection<String> coleccionValores = mapaCadenas.values();
    	List<String> listaValores = new ArrayList<>(coleccionValores);
    ...
    {
    	Collection<String> coleccionLlaves = mapaCadenas.keySet();
    	List<String> listaLlaves = new ArrayList<>(coleccionLlaves);
    ...
    public String getPrimera( )
    {
        ...
        // Recorrer el conjunto de llaves para encontrar la menor
    ...
    public String getUltima( )
    {
    	...
    	Collection<String> llaves = mapaCadenas.keySet();
        String llaveMayor = null;

        for (String llave : llaves) {
            if (llaveMayor == null || llave.compareTo(llaveMayor) > 0) {
            	llaveMayor = llave;
            }
        }
        return llaveMayor;
    ...
    {
    	HashMap<String, String> mapaMayusculas = new HashMap<>();
    	for (Map.Entry<String, String> pareja : mapaCadenas.entrySet()) {
    		...
    		mapaMayusculas.put(llaveMayus, valor);
    	}
    	mapaCadenas = mapaMayusculas;
    }
