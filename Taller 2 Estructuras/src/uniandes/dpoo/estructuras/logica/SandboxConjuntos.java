...
public class SandboxConjuntos
{
    ...
    {
    	List<String> nuevaLista = new ArrayList<String>(arbolCadenas);
    ...
    public String getPrimera( )
    {
    	if (arbolCadenas.isEmpty()) {
    		...
    		String menor = arbolCadenas.getFirst();
    		return menor;
    	}
    }
    ...
    public String getUltima( )
    {
    	if (arbolCadenas.isEmpty()) {
    		...
    		String mayor = arbolCadenas.getLast();
    		return mayor;
    	}
    }
    ...
    {
        Collection<String> resultado = new LinkedList<>();

        for (String string : arbolCadenas) {
            if (string.compareTo(cadena) >= 0) {
    ...
    public void volverMayusculas( )
    {
        ...
        arbolCadenas.clear();
        arbolCadenas.addAll(listaCadenas);
    }
    ...
    {
    	TreeSet<String> arbolInvertido = (TreeSet<String>) arbolCadenas.reversed();
